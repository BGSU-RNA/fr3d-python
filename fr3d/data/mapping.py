...
# NOTES: 
    ...
    # parent_atom_to_modified['PSU']['C5'] = 'N1': PSU is modified, N1 is from modified PSU, corresponds to parent U's C5
...
# print(modified_base_to_hydrogens)
# print(modified_base_to_hydrogens_coordinates['OMG']['HN1'])
