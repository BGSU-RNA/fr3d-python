...
# testing translation and rotation

                print base_residue.sequence, base_residue.number, base_residue.chain

                print base_residue.coordinates()
                print base_residue.centers['base']
                print base_residue.rotation_matrix

                print base_residue.standard_transformation()

                newbase = base_residue.transform(base_residue.standard_transformation())

                print newbase.coordinates()
                print newbase.centers['base']

                print "Result of translate_rotate on this base, relative to this base:"
                newerbase = base_residue.translate_rotate_component(base_residue)
                print newerbase.coordinates()
                print newerbase.centers['base']

                print newerbase.rotation_matrix
